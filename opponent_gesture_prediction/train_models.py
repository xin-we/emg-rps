...
def train_and_evaluate(train_data, test_data, feature_cols, model_path, trial, label="opponent"):
    ...
    for EID in range(1, 2):
        for pid in [1, 2]:
            ...
            for trial in range(1, 2):
                train_path = input_dir / f"E{EID}_P{pid}_train_{trial}.csv"
                test_path = input_dir / f"E{EID}_P{pid}_test_{trial}.csv"
                ...
                train_and_evaluate(train_data, test_data, feature_cols, model_path, trial, label)
