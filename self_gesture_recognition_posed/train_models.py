...
def train_and_evaluate_model(df, label_col, model_root, pred_root, EID, pid):
...
def main():
    ...
    for EID in range(1, 2):
        for pid in [1, 2]:
            ...
            train_and_evaluate_model(df, label_col="class", model_root=model_root, pred_root=pred_root, EID=EID, pid=pid)
